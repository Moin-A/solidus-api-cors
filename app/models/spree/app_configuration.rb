...
# Original location: solidus_core/lib/spree/app_configuration.rb
#
...
module Spree
  class AppConfiguration < Preferences::Configuration
    ...
    # Returns the RoleConfiguration instance for managing role-to-permission mappings.
    # At application level - can be customized!
    # Additional role configurations can be set in config/initializers/spree.rb
    def roles
